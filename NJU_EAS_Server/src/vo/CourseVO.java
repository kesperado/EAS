...
//	}
	...
	public CourseVO(CoursePO coursePO){
		this.id=coursePO.getID();
		this.name=coursePO.getName();
		this.credit=coursePO.getCredit();
		this.grade=coursePO.getGrade();
		this.targetdepartment = coursePO.getTargetDepartment();
		this.department=coursePO.getDepartment();
		this.coursetype=coursePO.getCourseType();
		this.time=coursePO.getTime();
		this.classroom=coursePO.getClassroom();
		this.memberlimit=coursePO.getMemberLimit();
		this.outline=coursePO.getOutline();
		this.textbook=coursePO.getTextbook();
		this.referencebook=coursePO.getReferenceBook();
		this.testtime = coursePO.getTestTime();
		this.canselect=coursePO.getCanSelect();
		this.canquit=coursePO.getCanQuit();
	}
